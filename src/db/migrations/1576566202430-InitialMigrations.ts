...
export class InitialMigrations1576566202430 implements MigrationInterface {
    name = 'InitialMigrations1576566202430'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "challenge" ("id" SERIAL NOT NULL, "type" "challenge_type_enum" NOT NULL, "maxAwardablePoints" integer NOT NULL, "awardedPoints" integer NOT NULL, "maxSectionsCompletable" integer NOT NULL, "sectionsCompleted" "challenge_sectionscompleted_enum" array NOT NULL DEFAULT '{}', "sharedFriendsImages" character varying array NOT NULL DEFAULT '{}'::character varying[], "recipeId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5f31455ad09ea6a836a06871b7a" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "user_profile" ("id" character varying NOT NULL, "totalPoints" integer NOT NULL, "challengeGoals" integer NOT NULL, "motivations" character varying NOT NULL, "username" character varying NOT NULL, "bio" character varying NOT NULL, "lowResProfile" character varying NOT NULL, "standardResolution" character varying NOT NULL, "challengeQuote" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f44d0cd18cfd80b0fed7806c3b7" PRIMARY KEY ("id"))`, undefined);
