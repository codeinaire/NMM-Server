...
export class AllMigrationsInOne1580427505228 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "challenge" ("id" SERIAL NOT NULL, "type" "challenge_type_enum" NOT NULL DEFAULT 'Recipe', "difficulty" "challenge_difficulty_enum" NOT NULL DEFAULT '1', "maxAwardablePoints" integer, "awardedPoints" integer, "maxSectionsCompletable" integer, "sectionsCompleted" "challenge_sectionscompleted_enum" array NOT NULL DEFAULT '{None}', "sharedFriendsImages" text, "recipeId" integer, "userProfileId" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5f31455ad09ea6a836a06871b7a" PRIMARY KEY ("id"))`,
      undefined
    )
    await queryRunner.query(
      `CREATE TABLE "completed_challenge" ("id" SERIAL NOT NULL, "userProfileId" character varying, "challengeId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d6aca49a38bceefc003f4ad83da" PRIMARY KEY ("id"))`,
      undefined
    )
    await queryRunner.query(
      `CREATE TABLE "uncompleted_challenge" ("id" SERIAL NOT NULL, "userProfileId" character varying, "challengeId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7304d4455a20e61f1b789f79960" PRIMARY KEY ("id"))`,
      undefined
    )
    await queryRunner.query(
